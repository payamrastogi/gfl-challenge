...
import com.gfl.service.feignclient.ElasticSearch;
import com.gfl.service.feignclient.SfBayFeignClient;
import com.gfl.service.feignclient.SfBaySearch;
...
public class GflServiceResource
{
	private static Logger logger = LoggerFactory.getLogger(GflServiceResource.class);
	...
	public static Config initConfig()
	{
		...
		try
		{
			...
			File file = new File("./gfl-service/config.properties");
			if (!file.exists()) 
			{
